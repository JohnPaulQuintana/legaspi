          ...
          <div className="col-lg-4 col-md-6">
            <div className="logo">
              <Link className="logo w-[150px] desktop:w-[150px]" to="/">
                ...
                <span className="text-primary-red font-bold"><i className="fa-sharp fa-regular fa-triangle rotate-90 font-bold"></i> GUILLERMO D.</span>
              </Link>
            </div>
          </div>
          ...
          <div className="col-lg-4 order-md-3">
            <div className="text-center">
              <p className="text-xl tablet:text-2xl">
                © {new Date().getFullYear()} Guillermo D. Legaspi Jr. {" "}
