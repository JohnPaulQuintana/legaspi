                ...
                <div className="row">
                    <div className="col-lg-4 valign">
                        <div className="sec-head info-box full-width md-mb80">
                            <div className="phone fz-30 fw-600 underline text-primary-red">
                                <a href="tel:+639077273286" className='text-2xl'>+63 9077 273 286</a>
                            </div>
                            ...
                            <div className="social-icon-circle mt-4 flex gap-2">
                                ...
                                <a href="tel:+639077273286">
                                    <i className="fa-brands fa-whatsapp"></i>
                                </a>
                                <a href="#">
                                    <i className="fab fa-skype"></i>
                                </a>
                                <a href="mailto:guillermolegaspi@rocketmail.com">
                    ...
                    <div className="col-lg-7 offset-lg-1 valign">
                        <div className="full-width">
                            <div className="sec-head mb-4">
                                <h6 className="sub-title text-primary-red mb-2 font-bold">Let's Chat</h6>
