        ...
        >
          <div className="mt-24 w-full grid grid-cols-1 laptop:grid-cols-3 justify-between items-center gap-4">
            ...
            <div className="flex justify-center block laptop:hidden">
              <img src="https://www.freeiconspng.com/thumbs/profile-icon-png/user-icon-png-person-user-profile-icon-20.png" alt="" className="w-[80%] border" />
            </div>
            {/* text */}
            <div className="col-span-2 flex flex-col gap-4 w-full pt-10">
              <h1 className="text-2xl tablet:text-4xl font-bold tracking-wide">
                <span className="text-primary-red">Hello,</span> I'm Guillermo D. Legaspi jr.
                Based in Philippines
              </h1>
              <p className="text-sm tablet:text-base">Fire and Emergency Officer | LDRRM assistant | Fire Marshal.</p>
              ...
              <div className="flex justify-start gap-2">
                <a type="button"
                  ...
                  className="bg-primary-red p-2 rounded-md text-base wide:text-2xl font-bold">Let's Connect
                </a>
                <a type="button"
                  onClick={(e) => {
                    e.preventDefault()
            ...
            <div className="flex justify-end hidden laptop:block">
              <img src="https://www.freeiconspng.com/thumbs/profile-icon-png/user-icon-png-person-user-profile-icon-20.png" alt="" className="w-full border" />
            </div>
        ...
        <ul className="grid grid-cols-4 justify-center gap-2 fz-14">
          <li className="hover-this cursor-pointer p-3 bg-[#1d1d1d] rounded-md">
            <a
              ...
              className="hover-anim flex items-center justify-center gap-2 text-4xl phone:text-xl"
            >
              <i className="fab fa-facebook-f text-primary-red"></i>{" "}
              <span className="hidden phone:block">Facebook</span>
            </a>
          </li>
          <li className="hover-this cursor-pointer p-3 bg-[#1d1d1d] rounded-md">
            <a
              ...
              className="hover-anim flex items-center justify-center gap-2 text-4xl phone:text-xl"
            >
              <i className="fa-brands fa-whatsapp text-md text-primary-red"></i>{" "}
              <span className="hidden phone:block">Whatsapp</span>
            </a>
          </li>
          <li className="hover-this cursor-pointer p-3 bg-[#1d1d1d] rounded-md">
            <a
              ...
              className="hover-anim flex items-center justify-center gap-2 text-4xl phone:text-xl"
            >
              <i className="fab fa-skype text-primary-red"></i>{" "}
              <span className="hidden phone:block">Skype</span>
            </a>
          </li>
          <li className="hover-this cursor-pointer p-3 bg-[#1d1d1d] rounded-md">
            <a
              ...
              className="hover-anim flex items-center justify-center gap-2 text-4xl phone:text-xl"
            >
              <i className="fa-regular fa-envelope text-primary-red"></i>{" "}
              <span className="hidden phone:block">Email</span>
            </a>
          </li>
        </ul>
