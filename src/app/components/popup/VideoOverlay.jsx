    ...
    return (
        <>
            ...
            <div id="video-dialog">
                ...
                <iframe id="video-iframe" src={"https://view.officeapps.live.com/op/view.aspx?src="+imageSrc} frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen></iframe>
