    ...
    return (
        <div className="hamenu one-scroll">
            <div className="logo icon-img-250">
                <span className="text-color-primary-green font-bold"><i className="fa-sharp fa-regular fa-triangle rotate-90 font-bold"></i> Guillermo D.</span>
            </div>
                    ...
                    <div className="col-lg-3">
                        <div className="cont-info">
                            <div className="item mb-50">
                                ...
                                <h5>
                                    0266-10 Silverland Phase 3,
                                    <br /> Duale, Limay, Bataan
                                </h5>
                            </div>
                            <div className="item mb-50">
                            ...
                            <div className="item mb-40">
                                ...
                                <h5>
                                    <a href="mailto:kingbbarawid5@gmail.com">guillermolegaspi@rocketmail.com</a>
                                </h5>
